...
export class K8sSandboxService {
  ...
  getServiceUrls(sessionId: string): { mastra: string; astro: string; vscode: string } {
    ...
    return {
      mastra: `https://${hostname}/mastra`,
      astro: `https://${hostname}/astro`,
      vscode: `https://${hostname}/`,
    };
  }
...
# Main HTTPS endpoint: https://${hostname}
https://${hostname} {
  tls {
    get_certificate tailscale
  }

  # VS Code Server (default)
  handle /* {
    ...
    return {
      ...
      spec: {
        ...
        containers: [
          ...
          // T095f, T095i: Caddy sidecar for HTTPS termination
          {
            name: 'caddy',
