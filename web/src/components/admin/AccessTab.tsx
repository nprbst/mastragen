    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex">
          ...
          <div className="ml-3">
            <h4 className="text-sm font-medium text-blue-800">GitHub-based Access</h4>
      ...
      {project.githubRepo ? (
        <div className="border border-gray-200 rounded-lg divide-y divide-gray-200">
          <div className="p-4">
            <h4 className="text-sm font-medium text-gray-900">Linked Repository</h4>
          ...
          <div className="p-4">
            <h4 className="text-sm font-medium text-gray-900">Who Has Access</h4>
